...
export const translations = {
  en: {
    ...
    hero: {
      ...
      description:
        "Senior Full Stack Engineer with 4+ years building enterprise HR/payroll platforms, ERP integrations with SAP & Dynamics 365, REST APIs and business automation systems.",
    ...
    about: {
      ...
      section_title: "Focused on building systems that work",
      p1: "Senior Full Stack Engineer with 4+ years of experience building enterprise software — HR & payroll platforms, ERP integrations, REST APIs, and business process automation at production scale.",
      p2: "At Wondrix I led integrations with SAP, Dynamics 365, and GeoVictoria, reducing integration development time by 80% and improving MongoDB query performance by 70%.",
      p3: "I care about clean architecture, structured error handling, and writing code that teams can maintain long-term. Currently pursuing a Master's in Data Management & Analytics.",
      stat_1_value: "4+",
      stat_1_label: "Years of experience",
      stat_2_value: "10+",
      stat_2_label: "Enterprise modules built",
      stat_3_value: "5+",
      stat_3_label: "ERP integrations shipped",
    },
    skills: {
    ...
    experience: {
      section_label: "Technical Focus",
      section_title: "Where I add value",
      subtitle:
        "My experience is concentrated in enterprise backend systems — not side projects, but production software used by real businesses.",
      ...
      area_hr_b1: "Attendance and shift management modules",
      area_hr_b2: "Benefit and deduction calculation engines",
      area_hr_b3: "Tax withholding and legal compliance logic",
      area_hr_b4: "Mass payroll generation with async processing",
    },
    projects: {
      section_label: "Work",
      section_title: "Featured Projects",
      subtitle:
        "Production-oriented projects built around real enterprise needs — not clones.",
      highlights_label: "Key highlights",
      view_github: "GitHub",
      view_live: "Live demo",
      project_1_title: "Enterprise REST API",
      project_1_desc:
      ...
      project_2_h1: "Real-time KPI charts and trend analysis",
      project_2_h2: "Multi-criteria filtering engine",
      project_2_h3: "One-click Excel report export",
      project_2_h4: "Responsive layout optimized for large datasets",
      project_3_title: "Excel → API Automation Tool",
      project_3_desc:
      ...
      project_3_h1: "Batch Excel file processing",
      project_3_h2: "Schema-level data validation",
      project_3_h3: "Automated report generation",
      project_3_h4: "Structured audit logs per execution",
      project_4_title: "Administrative Management System",
      project_4_desc:
      ...
      project_4_h1: "Session-based authentication system",
      project_4_h2: "Granular role and permission management",
      project_4_h3: "CRUD modules with server-side pagination",
      project_4_h4: "Admin metrics and activity dashboard",
    },
    contact: {
      section_label: "Contact",
      section_title: "Let's work together",
      description:
        "I'm open to full-time roles, freelance projects, and consulting opportunities in backend development, API design, and enterprise systems.",
      email_label: "Email",
      github_label: "GitHub",
    ...
    work_history: {
      section_label: "Work History",
      section_title: "Where I've worked",
      present: "Present",
      job1_title: "Senior Full Stack Engineer",
      job1_company: "Wondrix Ecuador",
      job1_period: "Sep 2022 — Present",
      job1_type: "Remote",
      job1_desc:
      ...
      job3_period: "Jul 2020 — Aug 2022",
      job3_type: "Remote",
      job3_desc:
        "Full-stack web applications for clients across healthcare, education, tourism, and logistics industries.",
      job3_h1: "Student enrollment and academic scheduling systems",
    ...
    education: {
      ...
      degree1_title: "Master's Degree in Data Management & Analytics",
      degree1_spec: "Business Intelligence Specialization",
      degree1_school: "Universidad Bolivariana del Ecuador",
      degree1_year: "2026",
      degree1_desc:
        "Focus on Business Intelligence, Data Analytics, Information Systems, Data Visualization, and Decision-Making Systems.",
      degree2_title: "Computer Systems Engineering",
      degree2_school: "Universidad Técnica de Babahoyo",
      degree2_year: "2022",
      degree2_desc:
        "Software engineering fundamentals, systems architecture, databases, and software development methodologies.",
  ...
  es: {
    ...
    hero: {
      greeting: "Hola, soy",
      name: "Jonathan Vera",
      role: "Desarrollador Senior Backend & Full Stack",
      description:
        "Senior Full Stack Engineer con 4+ años construyendo plataformas empresariales de RRHH/nómina, integraciones ERP con SAP y Dynamics 365, APIs REST y sistemas de automatización.",
    ...
    about: {
      ...
      section_title: "Enfocado en construir sistemas que funcionan",
      p1: "Senior Full Stack Engineer con más de 4 años de experiencia construyendo software empresarial — plataformas de RRHH y nómina, integraciones ERP, APIs REST y automatización de procesos a escala de producción.",
      p2: "En Wondrix lideré integraciones con SAP, Dynamics 365 y GeoVictoria, reduciendo el tiempo de desarrollo de integraciones en un 80% y mejorando el rendimiento de consultas MongoDB en un 70%.",
      p3: "Me importa la arquitectura limpia, el manejo estructurado de errores y escribir código que los equipos puedan mantener a largo plazo. Actualmente cursando una Maestría en Gestión y Análisis de Datos.",
      stat_1_value: "4+",
      stat_1_label: "Años de experiencia",
      stat_2_value: "10+",
      stat_2_label: "Módulos empresariales construidos",
      stat_3_value: "5+",
      stat_3_label: "Integraciones ERP entregadas",
    },
    skills: {
      section_label: "Stack Técnico",
      section_title: "Tecnologías con las que trabajo",
      backend: "Backend",
      frontend: "Frontend",
    ...
    experience: {
      section_label: "Enfoque Técnico",
      section_title: "Dónde genero valor",
      subtitle:
        "Mi experiencia está concentrada en sistemas backend empresariales — no proyectos personales, sino software de producción usado por empresas reales.",
      ...
      area_hr_desc:
        "Construí módulos core para sistemas de gestión de recursos humanos incluyendo control de asistencia, programación de turnos, procesamiento de beneficios y generación de nómina.",
      area_hr_b1: "Módulos de gestión de asistencia y turnos",
      area_hr_b2: "Motores de cálculo de beneficios y deducciones",
      area_hr_b3: "Lógica de retención de impuestos y cumplimiento legal",
      area_hr_b4: "Generación masiva de nómina con procesamiento asíncrono",
    },
    projects: {
      section_label: "Trabajo",
      section_title: "Proyectos Destacados",
      subtitle:
        "Proyectos orientados a producción construidos en torno a necesidades empresariales reales — no clones.",
      highlights_label: "Puntos clave",
      view_github: "GitHub",
      view_live: "Demo en vivo",
      project_1_title: "API REST Empresarial",
      project_1_desc:
        "API REST modular con autenticación JWT, control de acceso por roles, validación de inputs, documentación Swagger y arquitectura en capas limpia.",
      ...
      project_3_h1: "Procesamiento batch de archivos Excel",
      project_3_h2: "Validación de datos a nivel de esquema",
      project_3_h3: "Generación automática de reportes",
      project_3_h4: "Logs de auditoría estructurados por ejecución",
      project_4_title: "Sistema de Gestión Administrativa",
      project_4_desc:
        "Panel administrativo interno con autenticación, gestión de usuarios, asignación de roles, módulos CRUD, filtros dinámicos y dashboard de control.",
      project_4_h1: "Sistema de autenticación basado en sesiones",
      project_4_h2: "Gestión granular de roles y permisos",
      project_4_h3: "Módulos CRUD con paginación server-side",
      project_4_h4: "Dashboard de métricas y actividad administrativa",
    },
    contact: {
      section_label: "Contacto",
      section_title: "Trabajemos juntos",
      description:
        "Estoy abierto a roles de tiempo completo, proyectos freelance y consultoría en desarrollo backend, diseño de APIs y sistemas empresariales.",
      email_label: "Correo",
      github_label: "GitHub",
      linkedin_label: "LinkedIn",
      ...
      form_placeholder_message: "Cuéntame sobre tu proyecto u oportunidad...",
    },
    work_history: {
      section_label: "Trayectoria",
      section_title: "Dónde he trabajado",
      present: "Actualidad",
      job1_title: "Senior Full Stack Engineer",
      job1_company: "Wondrix Ecuador",
      job1_period: "Sep 2022 — Actualidad",
      job1_type: "Remoto",
      job1_desc:
      ...
      job3_company: "Freelance",
      job3_period: "Jul 2020 — Ago 2022",
      job3_type: "Remoto",
      job3_desc:
        "Aplicaciones web full-stack para clientes de salud, educación, turismo y logística.",
      job3_h1: "Sistemas de matrícula y programación académica",
    ...
    education: {
      ...
      degree1_title: "Maestría en Gestión y Análisis de Datos",
      degree1_spec: "Especialización en Business Intelligence",
      degree1_school: "Universidad Bolivariana del Ecuador",
      degree1_year: "2026",
      degree1_desc:
        "Enfocada en Business Intelligence, Analítica de Datos, Sistemas de Información, Visualización de Datos y Sistemas de Toma de Decisiones.",
      degree2_title: "Ingeniería en Sistemas Computacionales",
      degree2_school: "Universidad Técnica de Babahoyo",
      degree2_year: "2022",
      degree2_desc:
        "Fundamentos de ingeniería de software, arquitectura de sistemas, bases de datos y metodologías de desarrollo.",
